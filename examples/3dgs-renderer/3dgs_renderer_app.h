...
// Gaussian Splat Renderer Application
// Supports runtime switching between CPU and GPU sorting backends
class GaussianSplatRendererApp : public app::IApplication
{
  public:
	GaussianSplatRendererApp();
	~GaussianSplatRendererApp() override;

	GaussianSplatRendererApp(GaussianSplatRendererApp &&) noexcept;
	GaussianSplatRendererApp &operator=(GaussianSplatRendererApp &&) noexcept;
	GaussianSplatRendererApp(const GaussianSplatRendererApp &)            = delete;
	GaussianSplatRendererApp &operator=(const GaussianSplatRendererApp &) = delete;

...
GaussianSplatRendererApp::GaussianSplatRendererApp()
{
	m_fpsHistory.fill(0.0f);
}
GaussianSplatRendererApp::~GaussianSplatRendererApp()                                               = default;
GaussianSplatRendererApp::GaussianSplatRendererApp(GaussianSplatRendererApp &&) noexcept            = default;
GaussianSplatRendererApp &GaussianSplatRendererApp::operator=(GaussianSplatRendererApp &&) noexcept = default;

bool GaussianSplatRendererApp::OnInit(app::DeviceManager *deviceManager)
{
	LOG_INFO("=== GaussianSplatRendererApp Initialization ===");
...
void GaussianSplatRendererApp::ResetAsyncPipelineState()
{
...
void GaussianSplatRendererApp::SwitchBackend(BackendType newType)
{
...
void GaussianSplatRendererApp::ProcessPendingOperations()
{
	// Backend switch
...
void GaussianSplatRendererApp::OnUpdate(float deltaTime)
{
	m_camera.Update(deltaTime, m_deviceManager->GetWindow());
}

void GaussianSplatRendererApp::OnRender()
{
	...
	// Wait for image available and signal when rendering is done
...
void GaussianSplatRendererApp::OnShutdown()
{
	LOG_INFO("=== GaussianSplatRendererApp Shutdown ===");
...
void GaussianSplatRendererApp::OnKey(int key, int action, int mods)
{
...
void GaussianSplatRendererApp::OnMouseButton(int button, int action, int mods)
{
#if defined(__ANDROID__)
...
void GaussianSplatRendererApp::OnMouseMove(double xpos, double ypos)
{
#if defined(__ANDROID__)
...
void GaussianSplatRendererApp::OnScroll(double xoffset, double yoffset)
{
#if defined(__ANDROID__)
...
#if defined(__ANDROID__)
void GaussianSplatRendererApp::UpdateOrbitCamera()
{
...
void GaussianSplatRendererApp::OnFramebufferResize(int width, int height)
{
	(void) width;
	(void) height;
...
void GaussianSplatRendererApp::LoadSplatFile(const char *filepath)
{
...
void GaussianSplatRendererApp::CreateTestSplatData()
{
...
void GaussianSplatRendererApp::OnSceneBuffersChanged(const engine::Scene::GpuData &gpuData, uint32_t newSplatCount)
{
...
void GaussianSplatRendererApp::RecreateSHDependentPipelines()
{
	rhi::IRHIDevice    *device    = m_deviceManager->GetDevice();
	rhi::IRHISwapchain *swapchain = m_deviceManager->GetSwapchain();
...
void GaussianSplatRendererApp::RebindSceneDescriptors(uint32_t newSplatCount)
{
	rhi::IRHIDevice *device = m_deviceManager->GetDevice();
...
void GaussianSplatRendererApp::ReinitializeSortBackend(uint32_t newSplatCount)
{
	if (newSplatCount == 0)
	{
		m_backend.reset();
...
void GaussianSplatRendererApp::RecreateSwapchain()
{
	rhi::IRHIDevice    *device    = m_deviceManager->GetDevice();
	rhi::IRHISwapchain *swapchain = m_deviceManager->GetSwapchain();
...
void GaussianSplatRendererApp::InitGpuProfiling()
{
	if (!m_deviceManager)
	{
		return;
...
void GaussianSplatRendererApp::ShutdownGpuProfiling()
{
...
void GaussianSplatRendererApp::BeginGpuFrame(rhi::IRHICommandList *cmdList)
{
...
void GaussianSplatRendererApp::RecordPrecomputeTimestamp(rhi::IRHICommandList *cmdList, bool begin)
{
...
void GaussianSplatRendererApp::RecordSortTimestamp(rhi::IRHICommandList *cmdList, bool begin)
{
	if (!m_profilingEnabled || !m_timestampQueryPool || m_profilingJustEnabled)
	{
		return;
...
void GaussianSplatRendererApp::RecordRenderTimestamp(rhi::IRHICommandList *cmdList, bool begin)
{
	if (!m_profilingEnabled || !m_timestampQueryPool || m_profilingJustEnabled)
	{
		return;
...
void GaussianSplatRendererApp::RecordComputePreprocessTimestamp(rhi::IRHICommandList *cmdList, bool begin)
{
	if (!m_profilingEnabled || !m_timestampQueryPool || m_profilingJustEnabled)
	{
		return;
...
void GaussianSplatRendererApp::RecordComputeSortTimestamp(rhi::IRHICommandList *cmdList, bool begin)
{
	if (!m_profilingEnabled || !m_timestampQueryPool || m_profilingJustEnabled)
	{
		return;
...
void GaussianSplatRendererApp::RecordComputeRangesTimestamp(rhi::IRHICommandList *cmdList, bool begin)
{
	if (!m_profilingEnabled || !m_timestampQueryPool || m_profilingJustEnabled)
	{
		return;
...
void GaussianSplatRendererApp::RecordComputeRasterTimestamp(rhi::IRHICommandList *cmdList, bool begin)
{
	if (!m_profilingEnabled || !m_timestampQueryPool || m_profilingJustEnabled)
	{
		return;
...
void GaussianSplatRendererApp::BeginPipelineStatsQuery(rhi::IRHICommandList *cmdList)
{
...
void GaussianSplatRendererApp::EndPipelineStatsQuery(rhi::IRHICommandList *cmdList)
{
...
void GaussianSplatRendererApp::ReadAsyncPrecomputeTiming(uint32_t slotIndex)
{
	if (!m_asyncPrecomputeQueryPool || !m_profilingEnabled)
	{
		return;
...
void GaussianSplatRendererApp::ReadGpuTimingResults()
{
...
void GaussianSplatRendererApp::CollectAndLogBufferMemory()
{
...
void GaussianSplatRendererApp::PerformCrossBackendVerification()
{
...
void GaussianSplatRendererApp::InitImGui()
{
...
void GaussianSplatRendererApp::ShutdownImGui()
{
	// Cleanup ImGui
...
void GaussianSplatRendererApp::UpdateFpsHistory()
{
...
void GaussianSplatRendererApp::RenderImGui()
{
	...
	if (ImGui::Begin("3DGS Renderer Controls", &m_showImGui))
	{
...
void GaussianSplatRendererApp::RenderImGuiToCommandBuffer(rhi::IRHICommandList *cmdList)
{
...
#if defined(__ANDROID__)
bool GaussianSplatRendererApp::HandleImGuiInput(AInputEvent *event)
{
	if (!m_imguiEnabled)
	{
		return false;
...
void GaussianSplatRendererApp::CreateTransmCullingResources()
{
	auto *device    = m_deviceManager->GetDevice();
	auto *swapchain = m_deviceManager->GetSwapchain();
...
void GaussianSplatRendererApp::ResizeTransmCullingResources(uint32_t width, uint32_t height)
{
...
void GaussianSplatRendererApp::RenderTransmittanceCulling(

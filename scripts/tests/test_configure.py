...
from utils.configure_utils import (
    ...
    ConfigureError, PlatformError, CMakeError, BuildError, ValidationError,
...
from configure import (
    ...
    # Command classes
    Command, ConfigureCommand, BuildCommand, CommandFactory
)
...
class TestConfigureCommand(unittest.TestCase):
    ...
    def test_execute_success(self, mock_print_success, mock_run_cmake, mock_get_platform_config):
...
class TestBuildCommand(unittest.TestCase):
    ...
    def test_validation_run_multiple_targets(self):
        ...
        self.assertFalse(result.success)
        self.assertIsInstance(result.error, ValidationError)
        self.assertIn("--run can only be used with a single target", result.error.message)
    ...
    def test_determine_targets_all(self):
        ...
        with patch('configure.discover_build_targets') as mock_discover_targets:
            mock_discover_targets.return_value = ["triangle", "unit-tests", "perf-tests"]
